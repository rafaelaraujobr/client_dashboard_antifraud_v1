<template>
  <!-- <q-toolbar>
    ...
    <q-btn flat round dense icon="sym_r_today" />
    <q-btn flat round dense icon="sym_r_event_note" />
    <q-btn flat round dense icon="sym_r_calendar_month" />
    <q-btn flat round dense icon="sym_r_calendar_today" />
